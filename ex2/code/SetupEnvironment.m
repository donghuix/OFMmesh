function home = SetupEnvironment()
    ...
    elseif strcmp(home,'/global/homes/d/donghui')
        disp('Working on perlmutter!');
        addpath('/global/homes/d/donghui/inpoly');
        addpath('/global/cfs/projectdirs/m4267/petsc/petsc_main/share/petsc/matlab');
        addpath('/global/homes/d/donghui/mylib/m');
    else
